...
class Maze:
    ...
    def __init__(self, maze, start_cell=(0, 0), exit_cell=None):
        ...
        '''如果没有设定目标位置，认定【ncols-1,nrows-1]为目标位置'''
    ...
    def reset(self, start_cell=(0, 0)):
        ...
        self.__visited = set()  # a set() only stores unique value只存储唯一的值
